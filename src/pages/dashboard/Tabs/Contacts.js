                                                        ...
                                                        <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "8px" }}>
                                                            {s?.Avatar !== "Resource/no_img.jpg" ?
                                                                <div className="me-3 ms-0">
                                                                    <img src={`${process.env.REACT_APP_BASE_API_URL || localStorage.getItem("baseApi")}/Auth/img?key=${s?.Avatar}`} className="rounded-circle avatar-xs" alt="Chatlife" />
                                                                </div>
                                                    ...
                                                    <div className="d-flex align-items-center">
                                                        {child?.Avatar !== "Resource/no_img.jpg" ?
                                                            <div className={`${this.containUsersOnline(child?.Code) !== -1 ? "chat-user-img online" : "chat-user-img"} me-3 ms-0`}>
                                                                <img src={`${process.env.REACT_APP_BASE_API_URL || localStorage.getItem("baseApi")}/Auth/img?key=${child?.Avatar}`} className="rounded-circle avatar-xs" alt="Chatlife" />
                                                                {
