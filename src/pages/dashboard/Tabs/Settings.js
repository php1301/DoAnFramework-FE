                    ...
                    <div className="mb-4 profile-user input-file">
                        {
                            fileImage ?
                                props.profile?.Avatar === "Resource/no_img.jpg" ?
                                    ...
                                    <img src={fileImage || `${process.env.REACT_APP_BASE_API_URL || localStorage.getItem("baseApi")}/Auth/img?key=${props.profile?.Avatar}`} className="rounded-circle avatar-lg img-thumbnail" alt="Chatlife" />
                                : <img src={fileImage || `${process.env.REACT_APP_BASE_API_URL || localStorage.getItem("baseApi")}/Auth/img?key=${props.profile?.Avatar}`} className="rounded-circle avatar-lg img-thumbnail" alt="Chatlife" />
                        }
